  ...
  return (
    <main className="min-h-[100vh] w-[100vw] overflow-hidden bg-gradient-to-b from-[#0d0716] to-[#6468ab] flex items-center justify-center fixed inset-0">
      ...
      <div className="flex flex-col items-center justify-center relative w-full h-screen">
        ...
        {showWelcome && (
          <div className="absolute md:top-[6vh] top-[15vh] left-1/2 -translate-x-1/2 
            overflow-hidden whitespace-nowrap z-20 text-center w-full
            animate-typing">
            <p className={`${spaceGrotesk.className} text-white/90 text-xl sm:text-2xl md:text-3xl font-bold tracking-wider`}>
              Welcome to GeoAI
            </p>
          </div>
        )}
