...
export default function Home() {
  ...
  return (
    <main className="min-h-[100vh] w-[100vw] overflow-hidden bg-gradient-to-b from-[#0d0716] to-[#6468ab] flex items-center justify-center fixed inset-0">
      ...
      >
        <div className="opacity-100 scale-[0.6] sm:scale-75 md:scale-100">
      ...
      {/* Riddle display */}
      {isLoading && (
        <div className="fixed top-4 left-4 bg-white/10 backdrop-blur-md p-4 rounded-lg shadow-lg 
      ...
      {guessState.isReady && (
        <div className="fixed bottom-4 left-4 bg-white/10 backdrop-blur-md p-4 rounded-lg shadow-lg 
          w-[calc(100vw-2rem)] sm:w-[90vw] md:w-auto md:max-w-md animate-slideUp transition-all duration-500 ease-in-out">
